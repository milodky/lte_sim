...
static void Help (void)
{
	...
	std::cout <<
			...
			"\n"
			"\t ./LTE-Sim SingleCellWithFemto nbBuildings BuildingType activityRatio macro_cell_radius nbUE nbFemtoUE nbVoip nbVideo nbBE nbCBR sched_type frame_struct speed accessPolicy maxDelay videoBitRate seed(optional)"
			"\n\t\t --> ./LTE-Sim SingleCellWithFemto 2 0 1.0 1 1 1 0 0 1 0 1 1 3 0 0.1 128"
			"\n"
			"\t ./LTE-Sim Randomburst nbBuildings BuildingType activityRatio macro_cell_radius nbUE nbFemtoUE nbVoip nbVideo nbBE nbCBR nbRB sched_type frame_struct speed accessPolicy maxDelay videoBitRate filesize NbOfTransmission AverageSessionInterval IdleInterval SleepInterval"
			"\n\t\t --> ./LTE-Sim SingleCellWithFemto 2 0 1.0 1 1 1 0 0 1 0 1 1 3 0 0.1 128 1000000 100 5 1 0.5"
			"\n\n\n"
			"\n\t legend:"
			"\n\t\t schd_type: 1-> PF, 2-> M-LWDF, 3-> EXP, 4-> FLS (NOT AVAILABLE), 5 -> Optimize EXP Rule, 6 -> Optimized LOG Rule"
